...
-- p40-temperature.sql -- add support for recorded temperature from FIT files
--
...
alter table A_TRACKPOINT add column temperature real;

alter table SECTION_SUMMARY add column avg_temperature real;
alter table SECTION_SUMMARY add column max_temperature real;
