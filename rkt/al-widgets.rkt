...
(define *run-lap-fields*
  (list
   ...
   (mk-column-info "Vertical Oscillation" lap-avg-vertical-oscillation vosc->string)
   (mk-column-info "Ground Contact Time" lap-avg-stance-time n->string)
...
(define *bike-lap-fields*
  (list
   ...
   (mk-column-info "Normalized Power" lap-normalized-power n->string)

   (mk-column-info "Left-Right Balance" lap-left-right-balance n->string)
   (mk-column-info "Left Torque Effectiveness" lap-avg-left-torque-effectiveness n->string)
   (mk-column-info "Right Torque Effectiveness" lap-avg-right-torque-effectiveness n->string)
   (mk-column-info "Left Pedal Smoothness" lap-avg-left-pedal-smoothness n->string)
   (mk-column-info "Right Pedal Smoothness" lap-avg-right-pedal-smoothness n->string)
