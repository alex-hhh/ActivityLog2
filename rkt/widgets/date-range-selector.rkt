...
(define-values
  ...
  (let ([the-time-periods
         (vector
          (tp 'all-days "all days" (lambda () 0) this-day-end)
          (tp 'custom-dates "custom dates" (lambda () 'custom-dates) this-day-end)
          (tp 'seasons "seasons" (lambda () 'seasons) this-day-end)
          (tp 'last-7-days "last 7 days" last-7-days-start this-day-end)
          (tp 'this-week "this week" this-week-start this-day-end)
          (tp 'last-week "last week" last-week-start this-week-start)
          (tp 'last-30-days "last 30 days" last-30-days-start this-day-end)
          (tp 'this-month "this month" this-month-start this-day-end)
          (tp 'last-month "last month" last-month-start this-month-start)
          (tp 'last-6-weeks "last 6 weeks" last-6-weeks-start this-day-end)
          (tp 'last-6-months "last 6 months" last-6-months-start this-day-end)
          (tp 'last-365-days "last 12 months" last-365-days-start this-day-end)
          (tp 'this-year "this year" this-year-start this-day-end)
...
(define date-range-selector%
  (class object%
    ...
    (init-field [callback (lambda (_x) #f)])
    (super-new)
