...
(define *session-fields*
  '((254 . message-index)
    ...
    (124 . enhanced-avg-speed)
    (125 . enhanced-max-speed)
...
(define *session-conversions*
  `((timestamp             . ,fit-time->unix-time)
    ...
    (enhanced-avg-speed    . ,div-by-1000)
    (enhanced-max-speed    . ,div-by-1000)
    ...
    (avg-combined-pedal-smoothness . ,div-by-2)
...
(define *record-conversions*
  `((timestamp            . ,fit-time->unix-time)
    ...
    (enhanced-altitude    . ,(lambda (v) (- (/ v 5.0) 500)))
    (distance             . ,div-by-100)
    (speed                . ,div-by-1000)
    (enhanced-speed       . ,div-by-1000)
    (grade                . ,div-by-100)
    ...
    (combined-pedal-smoothness . ,div-by-2)
